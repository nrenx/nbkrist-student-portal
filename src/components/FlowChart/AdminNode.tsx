...
import { Shield, Database, CheckCircle, RefreshCw } from 'lucide-react';

interface AdminNodeData {
  label: string;
  description: string;
  icon?: string;
  category: string;
...
const AdminNode: React.FC<NodeProps<AdminNodeData>> = ({ data, isConnectable }) => {
  ...
  return (
    ...
    >
      <div
        className="px-5 py-4 rounded-lg shadow-md bg-white border-2 border-green-200 cursor-pointer min-w-[200px]"
